...
const createNewBoardInvitation = async (reqBody, inviterId) => {
  try {
    ...
    // Người được mời: lấy theo email nhận thư phía FE
  ...
  try {
    ...
    const updateData = {
      boardInvitation: {
        ...
        status: status // status là Accepted hoặc Rejected do FE
      }
    }
    ...
    // Bước 2: Nếu trường hợp Accept một lời mời thành công, thì cần phải thêm thông tin của thằng user
    // (userId) vào bản ghi memberIds trong collection board.
